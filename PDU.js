...
module.exports.mergePDVs = mergePDVs;
...
function pduByStream(stream) {
  ...
  switch (typeNum) {
    ...
    default : console.log("Unrecoginized pdu type " + pduType); break;
  }
  if (pdu)
    pdu.read(stream);
...
module.exports.pduByStream = pduByStream;
...
module.exports.AssociateRQ = AssociateRQ;
...
module.exports.AssociateAC = AssociateAC;
...
module.exports.AssociateAbort = AssociateAbort;
...
module.exports.ReleaseRQ = ReleaseRQ;
...
module.exports.ReleaseRP = ReleaseRP;
...
module.exports.PDataTF = PDataTF;
...
module.exports.PresentationDataValueItem = PresentationDataValueItem;
...
module.exports.ApplicationContextItem = ApplicationContextItem;
...
module.exports.PresentationContextItem = PresentationContextItem;
...
module.exports.AbstractSyntaxItem = AbstractSyntaxItem;
...
module.exports.TransferSyntaxItem = TransferSyntaxItem;
...
module.exports.UserInformationItem = UserInformationItem;
...
module.exports.ImplementationClassUIDItem = ImplementationClassUIDItem;
...
module.exports.ImplementationVersionNameItem = ImplementationVersionNameItem;
...
class MaximumLengthItem extends Item {
  ...
  readBytes(stream, length) {
    //let length = stream.read(C.TYPE_UINT32); //mik
...
module.exports.MaximumLengthItem = MaximumLengthItem;
