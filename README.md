...
Модуль позволяет создавать объекты <...> предназначенные для работы с потоками чтения и записи данных
в необработанном буфере - rewBuffer.


Модуль управления потоками чтения и записи данных (файловый, сетевой) в rawBuffer.
Модуль позволяет создавать объекты ... предназначенные для работы с потоками чтения и записи данных
в необработанном буфере для
